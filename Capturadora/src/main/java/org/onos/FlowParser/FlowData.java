...
public class FlowData {
    ...
    public String Export() {
        ...
        String data = flowId + "," + IPv4.fromIPv4Address(srcIP) + "," + srcPort + "," + IPv4.fromIPv4Address(dstIP)
                + "," + dstPort + "," +
                proto + "," + df.format(date) + "," + f[FWD_HDR_LEN].Get() + "," + f[BWD_HDR_LEN].Get() + ","
                + f[TOTAL_FWD_PKTS].Get() + "," +
                f[TOTAL_BWD_PKTS].Get() + "," + f[TOTAL_LEN_FWD_PKTS].Get() + "," + f[TOTAL_LEN_BWD_PKTS].Get() + ","
                ...
                f[BWD_IAT].ToArrayList().get(0) + "," + f[BWD_IAT].ToArrayList().get(1) + ","
                + f[BWD_IAT].ToArrayList().get(2) + "," +
                f[BWD_IAT].ToArrayList().get(3) + "," + f[ACTIVE].ToArrayList().get(0) + ","
                + f[ACTIVE].ToArrayList().get(1) + "," +
                f[ACTIVE].ToArrayList().get(2) + "," + f[ACTIVE].ToArrayList().get(3) + ","
                + f[IDLE].ToArrayList().get(0) + "," +
                f[IDLE].ToArrayList().get(1) + "," + f[IDLE].ToArrayList().get(2) + "," + f[IDLE].ToArrayList().get(3)
                + "," + f[FWD_PSH_FLAGS].Get() + "," + f[BWD_PSH_FLAGS].Get() + "," + f[FWD_URG_FLAGS].Get() + "," +
                f[BWD_URG_FLAGS].Get() + "," + f[FIN_FLAG_CNT].Get() + "," + f[SYN_FLAG_CNT].Get() + ","
                + f[RST_FLAG_CNT].Get() + "," +
                f[PSH_FLAG_CNT].Get() + "," + f[ACK_FLAG_CNT].Get() + "," + f[URG_FLAG_CNT].Get() + ","
                + f[CWE_FLAG_CNT].Get() + "," +
                f[ECE_FLAG_CNT].Get() + "," + f[DOWNUP_RATIO].Get() + "," + f[FWD_SEG_SIZE_AVG].Get() + ","
                ...
                + f[FLOW_BYTES_SEC].Get() + "," +
                f[FLOW_PKTS_SEC].Get() + "," + f[FWD_PKTS_SEC].Get() + "," + f[BWD_PKTS_SEC].Get() + ","
                + f[SUBFLOW_FWD_PKTS].Get() + "," + f[SUBFLOW_FWD_BYTES].Get() + "," + f[SUBFLOW_BWD_PKTS].Get() + "," +
                f[SUBFLOW_BWD_BYTES].Get() + "," + label;
